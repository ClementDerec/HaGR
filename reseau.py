...
net.fit(x_train,y_train, epochs=3, learning_rate=0.1) # il faut fournir une matrice 1,10
# a la place du tableau de distance 10, 

# test on 3 samples
out = net.predict(x_train[300000:300003])
print("\n")
...
print(y_train[0:3])
print("error : ")
print(mse(y_train[0],out[0]))
print(mse(y_train[1],out[1]))
print(mse(y_train[2],out[2]))